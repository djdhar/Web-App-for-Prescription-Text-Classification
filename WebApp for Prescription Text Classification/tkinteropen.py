...
def Classify(filename,hubba="foo"):
...
button = Button(mGui,text ='Choose a Prescription',command = lambda:openfile(saveImage), height=5, width=20).pack()
print(saveImage[0])
